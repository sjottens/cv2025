  ...
  return (
    <div className='werkervaring'>
        ...
        <p>
            ...
            *Front-end ontwikkelaar (UI) | 2013 – 2025*<br />
            ...
            *Stagiair Zeefdrukker | 1995 – 1996* <br />
            ...
            – HTML5, CSS, SCSS, JavaScript, TypeScript, React, Angular, NextJS<br />
            <strong>Tools & Software:</strong><br />
            – Git, Photoshop CC, Visual Studio, CapCut, Figma, Word, Google docs<br />
            <strong>CMS / Platforms:</strong><br />
            – Intershop, Optimizely, VWO<br />
            <strong>Overige:</strong><br />
            – SEO, A/B testen, Scrum, Google Analytics, ChatGPT<br />
        </p>
